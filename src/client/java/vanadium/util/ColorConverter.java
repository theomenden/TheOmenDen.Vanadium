...
import static vanadium.util.MathUtils.*;
...
public final class ColorConverter {
    ...
    public static float byteToNormalizedFloat(int color) {
        return (float)(0xFF & color) * INV_255;
    }
    ...
    public static float convertSRGBFloatToLinearAsFloat(float color) {
        ...
        if(clamped <= 0.0404482362771082f) {
            return color * INV_12_92;
        }
        return (float)Math.pow((clamped + 0.055f) * INV_1_055, 2.4f);
    }
    ...
    public static float convertLinearFloatToSRGBAsFloat(float color) {
        ...
        return 1.055f * (float)Math.pow(clamped, INV_2_4) - 0.055f;
    }
    ...
    public static float[] convertSrgbToOkLabAsFloatArray(int srgb) {
        float r = pivotRgbToLinear(((srgb >> 16) & 0xFF) * INV_255);
        float g = pivotRgbToLinear(((srgb >> 8) & 0xFF) * INV_255);
        float b = pivotRgbToLinear((srgb & 0xFF) * INV_255);
    ...
    public static float[] rgbToHsl(int rgb) {
        ...
        float redNormalized = red * INV_255;
        float greenNormalized = green * INV_255;
        float blueNormalized = blue * INV_255;
    ...
    private static float pivotLinearToRgb(float value) {
        ...
        return (float)(1.055 * Math.pow(value,INV_2_4) - 0.055);
    }
}
