...
public final class BiomeNameTracer {
    private static final Logger log = LogManager.getLogger(Chromatiq.MOD_ID);
    ...
    private static Map<Identifier, Identifier> createRenamedBiomeMap() {
        return Map.ofEntries(
                entry(new Identifier("mountains"), new Identifier("windswept_hills")),
                entry(new Identifier("snowy_tundra"), new Identifier("snowy_plains")),
                entry(new Identifier("jungle_edge"), new Identifier("sparse_jungle")),
                entry(new Identifier("stone_shore"), new Identifier("stony_shore")),
                entry(new Identifier("giant_tree_taiga"), new Identifier("old_growth_pine_taiga")),
                entry(new Identifier("wooded_mountains"), new Identifier("windswept_forest")),
                entry(new Identifier("wooded_badlands_plateau"), new Identifier("wooded_badlands")),
                entry(new Identifier("gravelly_mountains"), new Identifier("windswept_gravelly_hills")),
                entry(new Identifier("tall_birch_forest"), new Identifier("old_growth_birch_forest")),
                entry(new Identifier("giant_spruce_taiga"), new Identifier("old_growth_spruce_taiga")),
                entry(new Identifier("shattered_savanna"), new Identifier("windswept_savanna"))
            );
    }
