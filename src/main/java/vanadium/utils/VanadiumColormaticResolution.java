...
public final class VanadiumColormaticResolution {
    ...
    public static final BiomeColorMappingResource COLORMATIC_WATER_COLORS = new BiomeColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/water"));
    public static final BiomeColorMappingResource COLORMATIC_UNDERWATER_COLORS = new BiomeColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/underwater"));
    public static final BiomeColorMappingResource COLORMATIC_UNDERLAVA_COLORS = new BiomeColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/underlava"));
    public static final BiomeColorMappingResource COLORMATIC_SKY_COLORS = new BiomeColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/sky0"));
    public static final BiomeColorMappingResource COLORMATIC_FOG_COLORS = new BiomeColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/fog0"));
    public static final BiomeColorMappingResource COLORMATIC_BIRCH_COLORS = new BiomeColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/birch"));
    public static final BiomeColorMappingResource COLORMATIC_SPRUCE_COLORS = new BiomeColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/pine"));
    public static final LinearColorMappingResource COLORMATIC_PUMPKIN_STEM_COLORS = new LinearColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/pumpkinstem.png"));
    public static final LinearColorMappingResource COLORMATIC_MELON_STEM_COLORS = new LinearColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/melonstem.png"));
    public static final LinearColorMappingResource COLORMATIC_REDSTONE_COLORS = new LinearColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/redstone.png"));
    public static final LinearColorMappingResource COLORMATIC_MYCELIUM_PARTICLE_COLORS = new LinearColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/myceliumparticle.png"));
    public static final LinearColorMappingResource COLORMATIC_LAVA_DROP_COLORS = new LinearColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/lavadrop.png"));
    public static final LinearColorMappingResource COLORMATIC_DURABILITY_COLORS = new LinearColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/durability.png"));
    public static final LinearColorMappingResource COLORMATIC_EXPERIENCE_ORB_COLORS = new LinearColorMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "colormap/xporb.png"));
    public static final CustomBiomeColorMappingResource COLORMATIC_CUSTOM_BLOCK_COLORS = new CustomBiomeColorMappingResource();
    public static final GlobalLightMappingResource COLORMATIC_LIGHTMAP_PROPERTIES = new GlobalLightMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "lightmap.json"));
    public static final LightMappingResource COLORMATIC_LIGHTMAPS = new LightMappingResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "lightmap"));
    public static final GlobalColorResource COLORMATIC_COLOR_PROPERTIES = new GlobalColorResource(new ResourceLocation(Vanadium.COLORMATIC_ID, "color"));
